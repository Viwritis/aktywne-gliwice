package pl.redheadsolutions.aktywnegliwice.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pl.redheadsolutions.aktywnegliwice.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pl.redheadsolutions.aktywnegliwice.repository.UserRepository.USERS_BY_EMAIL_CACHE);
